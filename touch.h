/*
 * touch.h
 * Driver for the capacitive touch sensor included as an option for the display.
 * Use tp_isTouched to update the touch_t struct, check if (touch_t)->touchAvailable
 * is true, and read all the touch coordinations via tp_readTouch into the touch_t struct.
